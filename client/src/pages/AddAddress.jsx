...
const AddAddress = () => {
  ...
  // ✅ FIXED: proper redirect (no cart redirect bug)
  useEffect(() => {
    if (!user) {
      navigate("/");
    }
  ...
  return (
    <div className="mt-6 md:mt-10 flex flex-col lg:flex-row gap-6 px-3 sm:px-6 lg:px-10 bg-gray-100 rounded-lg shadow-md">
      ...
      <div className="flex-1 flex items-center justify-center">
        <img
          src={assets.add_address_iamge}
          alt="Address Illustration"
          className="w-full max-w-[250px] sm:max-w-xs mx-auto"
        />
      </div>
